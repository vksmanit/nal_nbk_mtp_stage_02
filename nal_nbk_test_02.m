function all_modified_edges_for_NAL =  nal_nbk_test_02(cktnetlist)
% --------------------------------------------------------------------------------
% syntax : all_modified_edges_for_NAL = nal_nbk_test_02(cktnetlist) 
%
...
%      end
%   end
    % working fine upto here : Apr 02, 2018
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
